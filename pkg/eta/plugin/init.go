...
import (
	...
	"github.com/davycun/eta/pkg/eta/plugin/plugin_auth"
	"github.com/davycun/eta/pkg/eta/plugin/plugin_crypt"
	"github.com/davycun/eta/pkg/eta/plugin/plugin_es"
	"github.com/davycun/eta/pkg/eta/plugin/plugin_geo"
	"github.com/davycun/eta/pkg/eta/plugin/plugin_his"
	"github.com/davycun/eta/pkg/eta/plugin/plugin_push"
)
...
func InitPlugin() error {
	...
	ctype.RegistryScanner(ctype.TypeStringName, plugin_crypt.StringScanner)
	ctype.RegistryScanner(ctype.TypeTextName, plugin_crypt.StringScanner)
	dgorm.Registry(plugin_crypt.NewEncryptPlugin())
